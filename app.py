...
<div class="main-header">
    ...
    <p>Tác giả: Trương Thị Xuân - Trường PTDTBT Tiểu học Ngam La - ĐT: 094 6094 778</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Trương Thị Xuân - Trường PTDTBT Tiểu học Ngam La - ĐT: 094 6094 778</div>", unsafe_allow_html=True)
